...
webhook_urls = {
    ...
    "OMG Leak": 'https://discord.com/api/webhooks/1313874393532989532/0mN1RuiIcN9zDC4HmE4PIOcAPN7B73tgX2TUHMpQH3EkmRTiy5LizlR1PZsnf-J0RSQs',
    "NotLeak": ''
}
...
def check_for_updates():
    ...
    if response_1.status_code == 200:
        ...
        if data_1 != last_data_1:
            send_webhooks(data_1, url_1, "Wuthering Waves CN (Starter)", last_data_1)
            last_data_1 = data_1
    else:
    ...
    if response_2.status_code == 200:
        ...
        if data_2 != last_data_2:
            send_webhooks(data_2, url_2, "Wuthering Waves CN (Game)", last_data_2)
            last_data_2 = data_2
    else:
        ...
        "embeds": [
            {
                ...
                "color": 16711680,  # https://convertingcolors.com/decimal-color-16711680.html?search=Decimal(16711680)
                "fields": embed_fields,
                "image": {
